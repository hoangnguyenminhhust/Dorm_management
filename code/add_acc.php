	...
	{	
		if($_POST['acc'] && $_POST['level'] && $_POST['name'] && $_POST['year'] &&$_POST['day'] && $_POST['pwd'] && $_POST['re_pwd'])
		{
			...
			if($pwd != $re_pwd)
				...
				$date_up=mysql_fetch_assoc($query2);
				$date=$date_up['CURDATE()'];
				$sql_kt = "select * from member where acc = '$acc';";
				$query_kt=mysql_query($sql_kt);
				if(mysql_num_rows($query_kt) == 0)
				{
					$sql3 = "insert into member values ($num,'$acc','$pwd','$level','$name','$birthday','$sex','$number','$address','$date');";
					mysql_query($sql3);
...
<div id='main'>
	...
	<div id='form'>
		<h1 style='font-size:25px;margin-top:15px;text-align:left;'>Thêm tài khoản</h1>
		...
		<div class='form-dk'>
			...
			<div class='tb'>
				...
				<div class='tr'>
					...
					<div class='js2'>
						<input type='password' name='re_pwd' class='text' /><br />
				...
				<div class='tr'>
					...
					<div class='js2'>
						<input type='radio' name='sex' value='Nam' checked /> Nam<br />
				...
				<div class='tr'>
					...
					<div class='js2'>
						...
						<input type='text' name='day' size='1' placeholder="Ngày" style='height:16px;padding:3px;' />
						<input type='text' name='year' size='2' placeholder="Năm" style='height:16px;padding:3px;' />
					</div>
				</div>
				<div class='tr'>
					<div class='js'>
			...
			<input type='submit' name='ok' value='Đăng kí' class='submit' />
